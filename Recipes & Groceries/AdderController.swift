...
class AdderController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextViewDelegate {
    ...
    @IBAction func addIngredient(_ sender: Any) {
        ...
        if amountField.text == "" || measurmentField.text == "" || ingredientField.text == "" {
            let alert = UIAlertController(title: "Incomplete Entry", message: "Please Enter a Value In All Three Fields", preferredStyle: .alert)
